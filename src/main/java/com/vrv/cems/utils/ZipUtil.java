...
public class ZipUtil {
    ...
    public static void zip(String sourceFolder, String zipFilePath) throws Exception {
        ...
        System.out.println("开始压缩 [" + sourceFolder + "] 到 [" + zipFilePath + "]");
...
//        }
        ...
        bos.close();
        out.close();
        logger.debug("压缩文件 [" + zipFilePath + "] 完成！");
        System.out.println("压缩文件 [" + zipFilePath + "] 完成！");
    }
    ...
    public static void zip(String[] sourceFolders, String zipFilePath) throws Exception {
        ...
        for (int i = 0; i < sourceFolders.length; i++) {
            ...
            String sourceFilePath = sourceFolders[i].replace("\\", "/");
        ...
        bos.close();
        out.close();
        logger.debug("压缩 " + sourceFolders.toString() + " 完成！");
    }
